...
-- Добавляем себя в белый список автоматически
    ...
    while true do
        if Settings.Enabled then
            for _, player in pairs(Players:GetPlayers()) do
                ...
                if player and player ~= Player and player.Name and not Whitelist[player.Name:lower()] and isPlayerAlive(Player) then
                    Fling(player)
